...
class CWH
{
	...
	public:
	   ...
	   //abstract base ka matlab hay kay isay or drived classes banai jay or isko object bananay kay lis use nhi kia jata
	   //abstract base class may kam say kam 1 pure virtual function hota hay
};
